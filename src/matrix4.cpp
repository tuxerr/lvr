...
Vec3f Matrix4::operator*(Vec3f vector) {
    Vec3f res;
...
void Matrix4::camera(Vec3f pos,Vec3f direction,Vec3f up_vector) {
    clear();
    Vec3f forward=direction-pos;
    forward.normalize();

    Vec3f side=forward*up_vector;
    side.normalize();
